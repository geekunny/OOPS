...
public class TestVector {
	...
	public static void main(String[] args) {
		...
		Vector list= new Vector(); //Code will run exactly the same as using ArrayList, the only difference is Vector 
		//has syncronized functions which will create a thread based program. If we want to use array lists in a thread
		//based program then we should use vector. ArrayList allows parallel access while Vector does not.
		String temp="Milk";
		list.add(temp); //0
		list.add("Bread"); //1
		list.add("Butter"); //2
